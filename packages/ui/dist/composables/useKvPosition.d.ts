...
export declare function useKvPosition(anchor: Ref<HTMLElement | null>, floating: Ref<HTMLElement | null>, open: Ref<boolean>, placement: Ref<KvPlacement>): {
    style: Ref<{
    ...
    resolvedPlacement: Ref<KvPlacement, KvPlacement>;
    update: () => Promise<void>;
};
//# sourceMappingURL=useKvPosition.d.ts.map